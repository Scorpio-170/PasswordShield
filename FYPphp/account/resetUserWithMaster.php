         ...
         if($row= mysqli_fetch_assoc($result)){
             ...
             if(password_verify($currentPw, $userMstPW)){
                if(password_verify($newPw, $userPW)){
                    header("Location: chrome-extension://aecdplfdmmhbdjflimkoagbocjnaaifl/accountSettings/chgPassword/forgetPwMstErr1.html");
                }else{
                 ...
                 header("Location: chrome-extension://aecdplfdmmhbdjflimkoagbocjnaaifl/accountSettings/chgPassword/forgetPwMstErr.html");
             }
        }else{
        echo "something went wrong";
             }
