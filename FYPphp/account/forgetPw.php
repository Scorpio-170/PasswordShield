<?php
    ...
    if(isset($_POST['checkEmailBtn'])){
        ...
        $_SESSION['resetEmail']=$resetEmail;
          ...
          if($resultCheck!=0)  
          {
            ...
            if(!$mail->send()){
                ...
                header("Location: chrome-extension://aecdplfdmmhbdjflimkoagbocjnaaifl/forgot_Pw/receiveEmail.html");
            }
          }else{
            header("Location: chrome-extension://aecdplfdmmhbdjflimkoagbocjnaaifl/forgot_Pw/forgot_PwErr.html");
          }
        ...
        if($verifyOTP==$existingOTP){
            unset($_SESSION['OTP']);
            header("Location: chrome-extension://aecdplfdmmhbdjflimkoagbocjnaaifl/forgot_Pw/resetUserPass.html");
        }else{
            header("Location: chrome-extension://aecdplfdmmhbdjflimkoagbocjnaaifl/forgot_Pw/receiveEmailErr.html");
        }
        ...
        if($resultCheck!=0)  
        {
            if($row= mysqli_fetch_assoc($result)){
                ...
                if(password_verify($newPw, $oldPW)){
                    header("Location: chrome-extension://aecdplfdmmhbdjflimkoagbocjnaaifl/forgot_Pw/resetUserPassErr.html");
                }else{
