<?php
    $currentPw = $con -> real_escape_string($_POST['currentPassword']);
         ...
         if($row= mysqli_fetch_assoc($result)){
             ...
             if(password_verify($currentPw, $userPW)){
                if(password_verify($newPw, $userPW)){
                    header("Location: chrome-extension://aecdplfdmmhbdjflimkoagbocjnaaifl/accountSettings/chgPassword/chgPasswordUpdateErr1.html");
                }else{
                 ...
                 header("Location: chrome-extension://aecdplfdmmhbdjflimkoagbocjnaaifl/accountSettings/chgPassword/chgPasswordUpdateErr.html");
             }
        }else{
        echo "something went wrong";
             }
