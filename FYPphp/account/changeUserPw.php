         ...
         if($row= mysqli_fetch_assoc($result)){
             ...
             if(password_verify($currentPw, $userPW)){
                if(password_verify($newPw, $userPW)){
                    header("Location: chrome-extension://kgnbabmgfmiogjhddmkkablkclfjdbcl/accountSettings/chgPassword/chgPasswordUpdateErr1.html");
                }else{
                 ...
                 header("Location: chrome-extension://kgnbabmgfmiogjhddmkkablkclfjdbcl/accountSettings/chgPassword/chgPasswordUpdateErr.html");
             }
        }else{
        echo "something went wrong";
             }
