         ...
         if($row= mysqli_fetch_assoc($result)){
             ...
             if(password_verify($currentPw, $userPW)){
                if(password_verify($newPw, $userMstPW)){
                    header("Location: chrome-extension://kgnbabmgfmiogjhddmkkablkclfjdbcl/accountSettings/chgMstPassword/forgetPwUsrErr1.html");
                }else{
                 ...
                 header("Location: chrome-extension://kgnbabmgfmiogjhddmkkablkclfjdbcl/accountSettings/chgMstPassword/forgetPwUsrErr.html");
             }
        }else{
        echo "something went wrong";
             }
