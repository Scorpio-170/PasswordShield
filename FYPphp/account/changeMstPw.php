         ...
         if($row= mysqli_fetch_assoc($result)){
             ...
             if(password_verify($currentMstPw, $userMstPW)){
                if(password_verify($newMstPw, $userMstPW)){
                    header("Location: chrome-extension://kgnbabmgfmiogjhddmkkablkclfjdbcl/accountSettings/chgMstPassword/chgMstPasswordUpdateErr1.html");
                }else{
                 ...
                 header("Location: chrome-extension://kgnbabmgfmiogjhddmkkablkclfjdbcl/accountSettings/chgMstPassword/chgMstPasswordUpdateErr.html");
             }
        }else{
        echo "something went wrong";
             }
