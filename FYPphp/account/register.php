<?php
    ...
    if(isset($_POST['registerAcc'])){
      ...
      $hashedMasterPassword = password_hash($masterPassword, PASSWORD_BCRYPT);
          ...
          if($resultCheck!=0)  
          {
            header("Location: chrome-extension://kgnbabmgfmiogjhddmkkablkclfjdbcl/register/registerErr.html");
          }else{
            ...
            if(!$mail->send()){
              ...
              $_SESSION['hashedMasterPassword']=$hashedMasterPassword;
                header("Location: chrome-extension://kgnbabmgfmiogjhddmkkablkclfjdbcl/register/receiveRegisterEmail.html");
            }
          }
      ...
      if($verifyOTP==$existingOTP){
        ...
        $passedHashedMasterPassword = $_SESSION['hashedMasterPassword'];
          ...
          header("Location: chrome-extension://kgnbabmgfmiogjhddmkkablkclfjdbcl/register/receiveRegisterEmailErr.html");
      }
    }
